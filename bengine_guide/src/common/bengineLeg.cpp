...
// Forward Kinematics(参考坐标系为侧摆关节)
Vec3 QuadrupedLeg::calcPEe2H(Vec3 angle){
...
// Forward Kinematics(参考坐标系为身体坐标系)
Vec3 QuadrupedLeg::calcPEe2B(Vec3 q){
    return _pHip2B + calcPEe2H(q);
}

// Derivative Forward Kinematics速度正向运动学
