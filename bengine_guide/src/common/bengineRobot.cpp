...
Vec3 QuadrupedRobot::getFootVelocity(LowlevelState &state, int id){
    Vec34 qLegs = state.get_position();
    Vec34 qdLegs= state.get_velocity();
...
BengineRobot::BengineRobot(){
    _Legs[0] = new BengineLeg(0, Vec3( 0.3526, -0.077, 0));           //右前腿
    _Legs[1] = new BengineLeg(1, Vec3( 0.3526,  0.077, 0));           //左前腿
    _Legs[2] = new BengineLeg(2, Vec3(-0.3526,  0.077, 0));           //左后腿
    _Legs[3] = new BengineLeg(3, Vec3(-0.3526, -0.077, 0));           //右后腿
